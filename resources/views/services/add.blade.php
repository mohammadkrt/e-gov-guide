            ...
            <div class="card" >
                <div class="card-body">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">إضـــافة خدمة</h4>
                        <p class="card-category"> الخدمات التي تقدمها وحدات الولاية المختلفة</p>
                    </div><br>
                    <div class="card-body">
                        <form action="{{route('service.insert')}}" method="post">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="service_name" name="service_name" placeholder="إســــم الخدمة">
                                @error('service_name')
                                <small class="form-text text-danger">{{$message}}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="description" name="description" placeholder="وصـف الخدمة">
                                @error('description')
                                <small class="form-text text-danger">{{$message}}</small>
                                @enderror
                            </div>
