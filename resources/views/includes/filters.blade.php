<div class="fixed-plugin">
    <div class="dropdown show-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="button-container">
                <a href="http://demos.creative-tim.com/material-dashboard/docs/2.1/getting-started/introduction.html"
            ...
            <li class="button-container github-star ml-auto text-center">
                <iframe
                    src="https://yvoschaap.com/producthunt/counter.html#href=https://demos.creative-tim.com/material-dashboard/presentation.html?ref=producthunt&layout=wide"
                    width="84" height="21" scrolling="no" frameborder="0" allowtransparency="true"></iframe>
