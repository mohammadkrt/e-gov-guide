            ...
            <div class="card" >
                <div class="card-body">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">تعديل شروط الخدمات</h4>
                        ...
                        <form action="{{route('condition.update', $condition->id)}}" method="post">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="service_id" name="service_id">
                                        ...
                                        @foreach($services as $service)
                                            <option value="{{ $service->id }}" {{$condition->service_id == $service->id  ? 'selected' : ''}}>{{ $service->service_name}}</option>
                                        @endforeach
                                    </select>
                                    @error('service_id')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="condition_name" value="{{$condition->condition_name}}" class="form-control" id="condition_name" placeholder=" شرط الخدمة">
