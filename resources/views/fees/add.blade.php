            ...
            <div class="card" >
                <div class="card-body">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">إضـــافة رسوم</h4>
                        <p class="card-category">رسوم الخدمات الحكومية</p>
                    </div><br>
                    <div class="card-body">
                        <form action="{{route('fees.insert')}}" method="post">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="fees_name" dir="rtl">الإســـم</label>
                                    <input type="text" name="fees_name" class="form-control" id="fees_name" placeholder="إســــم الرسم">
                                    @error('fees_name')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="fees_value" class="form-control" id="fees_value" placeholder="قـيمة الـرسم">
                                    @error('fees_value')
                                    <small class="form-text text-danger">{{$message}}</small>
                                    @enderror
                                </div>
